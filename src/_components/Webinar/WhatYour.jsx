...
const WhatYour = () => {
    ...
    return (
        <div className='container mx-auto py-5 space-y-10 min-h-[50vh]'>
                    ...
                    data.map((item, idx) => {
                        return <div className="">
                            <div className=" mx-auto ">
                                <div className="bg-white shadow-lg rounded-lg p-6 relative h-[15rem]">
            ...
            <div className='grid place-items-center'><button className='bg-slate-600 text-white px-6 py-3 rounded-3xl' type="button">Book Your Spot @ Rs.9</button></div>
        </div>
    )
}
